...
import { signInSchema, SignInFormValues } from '@/schemas';
  ...
  const onSubmit = async (data: SignInFormValues) => {
    try {
      ...
      if (apiErr?.errors) {
        ...
        Alert.alert('Sign In Failed', apiErr?.message ?? 'Invalid credentials');
      }
    }
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.subheading}>Sign in to your brain</Text>
